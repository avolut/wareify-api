...
import {
  IListUsersByRoleUseCase,
  ListUsersByRoleUseCaseFactory,
} from "../../../service/user/use-case/list-users-by-role-use-case";
import {
  IListUsersUseCase,
  ListUsersUseCaseFactory,
} from "../../../service/user/use-case/list-users-use-case";
export const _ = {
  url: "/api/users/",
  async api(roleParams?: string) {
